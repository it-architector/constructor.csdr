...
CSDR среда предназначена для визуального построения <a href="https://github.com/it-architector/right.csdr">конструктивного кода</a> всех языков программирования.
