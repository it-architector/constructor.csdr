...
4. **Значение** //значение для компонента, смотрите <a href="https://github.com/it-architector/structure.csdr">структуру CSDR</a>
...
Здесь должна быть ссылка "скачать", но увы. Framework'у требуются визуальные разработчики, тем, кому сия идея нужна. Скайп: poryadok2017