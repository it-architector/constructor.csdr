...
CSDR конструктор предназначен для визуального <a href="https://github.com/it-architector/project.csdr">проектирования конструктивного кода</a> в любом языке программирования.
