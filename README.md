...
С Framework'ом CSDR вы обретаете возможность визуально проектировать <a href="https://github.com/it-architector/code.csdr">конструктивный код</a>, централизуя весь функционал программы в сценариях.
