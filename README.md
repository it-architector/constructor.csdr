...
> В области **хода сборки** можно увидеть лог всех действий.
...
По кнопке компиляции создаётся новая версия модуля, которая будет включать в себя сделанные конструкции. Описание новой версии это ход планирования.
